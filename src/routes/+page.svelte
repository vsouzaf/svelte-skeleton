<script lang="ts">
    ...
    const componentProfileCard = "/img/component-profile-card.png";
    const componentInfoCard = "/img/component-info-card.png";
    const componentInfo2 = "/img/component-info-2.png";
    const componentMenu = "/img/component-menu.png";
    const componentBtnPink = "/img/component-btn-pink.png";
    const documentation = "/img/documentation.png";
    const login = "/img/login.jpg";

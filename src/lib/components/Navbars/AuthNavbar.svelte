<script lang="ts">
  // core components
  import PagesDropdown from "$lib/components/Dropdowns/PagesDropdown.svelte";
...
>
  ...
  >
    ...
    <div
      class="lg:flex flex-grow items-center lg:bg-opacity-0 lg:shadow-none rounded shadow-lg {navbarOpen ? 'block':'hidden'}"
